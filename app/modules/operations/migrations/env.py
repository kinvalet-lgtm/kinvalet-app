"""Alembic env.py for the operations module.

This module's migrations are isolated in the operations schema.
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table_schema="operations",
        include_schemas=True,
        include_object=lambda obj, name, type_, reflected, compare_to:
            getattr(obj, "schema", None) == "operations",
    )
